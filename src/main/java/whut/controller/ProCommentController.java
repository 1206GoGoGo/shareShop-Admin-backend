...
public class ProCommentController {
	...
	public @ResponseBody Object getListByProduct(String id) {
	...
	public @ResponseBody Object getListByUser(String id) {
		List<ProductComment> list = new ArrayList<>();
	...
	public @ResponseBody Object add(@RequestBody ProductComment productComment) {
	...
	public @ResponseBody Object addAgain(String id, String content) {
